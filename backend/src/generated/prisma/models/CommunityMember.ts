...
export type CommunityMemberWhereInput = {
  ...
  role?: Prisma.EnumCommunityMemberRoleFilter<"CommunityMember"> | $Enums.CommunityMemberRole
...
export type CommunityMemberScalarWhereWithAggregatesInput = {
  ...
  role?: Prisma.EnumCommunityMemberRoleWithAggregatesFilter<"CommunityMember"> | $Enums.CommunityMemberRole
...
export type CommunityMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"communityId" | "userId" | "role" | "joinedAt", ExtArgs["result"]["communityMember"]>
...
export interface CommunityMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const communityMemberWithCommunityIdOnly = await prisma.communityMember.findMany({ select: { communityId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CommunityMembers and only return the `communityId`
   * const communityMemberWithCommunityIdOnly = await prisma.communityMember.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more CommunityMembers and only return the `communityId`
   * const communityMemberWithCommunityIdOnly = await prisma.communityMember.updateManyAndReturn({
   *   select: { communityId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CommunityMemberFieldRefs {
  ...
  readonly role: Prisma.FieldRef<"CommunityMember", 'CommunityMemberRole'>
