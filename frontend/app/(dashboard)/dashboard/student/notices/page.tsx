...
const mockNotices: Notice[] = [
  {
    id: "1",
    title: "Assignment Due: Mathematics Chapter 5",
    message: "Complete Chapter 5 exercises and submit by December 12th. Late submissions will incur penalties.",
    type: "WARNING",
    isRead: false,
    createdAt: "2026-12-10T09:00:00Z",
    sender: { name: "A. Gurung (Mathematics)" },
  },
  {
    id: "2",
    title: "Mid-Term Exam Schedule Released",
    message: "The mid-term exam schedule has been published. Exams start December 15th. Check the timetable for details.",
    type: "ANNOUNCEMENT",
    isRead: true,
  ...
  },
  {
    ...
    message: "Winter vacation starts December 29th. School resumes January 12th. Complete all pending assignments before vacation.",
    type: "INFO",
    isRead: false,
  ...
  },
  {
    ...
    message: "Submit your Science lab report for the Physics experiment by December 18th. Include observations and conclusions.",
    type: "WARNING",
    isRead: true,
    createdAt: "2026-12-01T10:00:00Z",
    sender: { name: "S. Sharma (Science)" },
  },
  {
    id: "5",
    title: "English Essay Competition",
    message: "Annual English essay competition announced. Topic: 'My City'. Submit entries by December 20th to win prizes.",
    type: "SUCCESS",
    isRead: false,
    createdAt: "2026-11-28T16:00:00Z",
    sender: { name: "P. Rai (English)" },
  },
];
    ...
    <DashboardShell role="STUDENT">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-slate-500">Announcements and notifications</p>
