        ...
        <div className="p-6">
          ...
          {activeTab === "general" && (
            <div className="space-y-6 max-w-2xl">
              <div>
                <h3 className="font-semibold text-slate-900">Platform Information</h3>
                <p className="mt-1 text-sm text-slate-500">Basic information about your platform</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="url"
                    defaultValue="https://gyannportal.com"
                    className="mt-1 rounded-lg border border-slate-200 w-full px-4 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="email"
                    defaultValue="support@gyannportal.com"
                    className="mt-1 rounded-lg border border-slate-200 w-full px-4 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Enforce strong passwords for all users</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" className="sr-only peer" defaultChecked />
                    <div className="w-11 h-6 rounded-full bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all peer-checked:bg-blue-600" />
          ...
          {activeTab === "notifications" && (
            <div className="space-y-6 max-w-2xl">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Configure how you receive platform notifications</p>
              </div>

              <div className="space-y-4">
                {[
                  { label: "New School Registration", description: "When a new school registers" },
                  { label: "System Alerts", description: "Critical system notifications" },
                  { label: "Weekly Analytics", description: "Weekly platform metrics summary" },
                  { label: "Security Alerts", description: "Suspicious activity warnings" },
                  { label: "Billing Notifications", description: "Invoice and payment updates" },
                ].map((item) => (
          ...
          {activeTab === "appearance" && (
            <div className="space-y-6 max-w-2xl">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Customize the look and feel of the platform</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Enable dark theme across the platform</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
