...
export default function TeacherMarksPage() {
  return (
    <CrudPage<Result>
      title="Marks"
      description="Grades you have recorded for exams."
      role="TEACHER"
      resource={{
        list: teachersApi.getMyResults,
        create: resourceMutator(teachersApi.createResult),
        update: resourceUpdater(teachersApi.updateResult),
      }}
      columns={[
        {
          key: "student",
      ...
      fields={[
        ...
        { name: "studentId", label: "Student ID", required: true, hint: "From your Students page." },
      ...
      canCreate
      canUpdate
      createTitle="Add Marks"
      editTitle="Edit Marks"
    />
  );
}