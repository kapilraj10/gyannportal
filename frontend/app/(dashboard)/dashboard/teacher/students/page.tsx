...
export default function TeacherStudentsPage() {
  ...
  async function fetchStudents() {
    setLoading(true);
    try {
      const response = await api.get<Envelope<Student[]>>("/teachers/me/students", {
    ...
    <DashboardShell role="TEACHER">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-slate-500">Students in your assigned classes</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">My Students</h2>
          </div>
        </div>
      </div>
                  ...
                  <tr key={student.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button className="rounded-lg p-2 text-slate-500 hover:bg-slate-100 hover:text-slate-700" title="View Marks">
